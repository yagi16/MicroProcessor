...
set_property PACKAGE_PIN V8 [get_ports {ioa[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioa[0]}]
set_property PACKAGE_PIN W8 [get_ports {ioa[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioa[1]}]
set_property PACKAGE_PIN U7 [get_ports {ioa[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioa[2]}]
set_property PACKAGE_PIN V7 [get_ports {ioa[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioa[3]}]
set_property PACKAGE_PIN Y7 [get_ports {ioa[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioa[4]}]
set_property PACKAGE_PIN Y6 [get_ports {ioa[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioa[5]}]
set_property PACKAGE_PIN V6 [get_ports {ioa[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioa[6]}]
set_property PACKAGE_PIN W6 [get_ports {ioa[7]}]
